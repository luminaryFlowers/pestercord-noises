...
module.exports = class PestercordNoises {
    ...
    attemptUpdateSounds() {
        if((this.connectModule && this.disconnectModule) || Object.keys(this.modules).length === this.moduleCount) return;
    ...
    stop() {
        try {
            this.connectModule.exports = "/assets/5dd43c946894005258d85770f0d10cff.mp3";
        } catch {}

        try {
            this.disconnectModule.exports = "/assets/7e125dc075ec6e5ae796e4c3ab83abb3.mp3";
        } catch {}
    }
