...
module.exports = class PestercordNoisesCall {
    ...
    attemptUpdateSounds() {
        return this.updateConnect() + this.updateDisconnect() + this.updateOtherDisconnect();
    }
                    ...
                    <svg width="48" height="48" viewBox="0 0 48 48" class="svg-2zuE5p" overflow="visible">
                        ...
                        <foreignObject mask="url(#aa635ce3-5b7f-4319-8151-5d8e41aed794)" x="0" y="0" width="48" height="48">
                            <div class="circleIconButton-1VxDrg">
                                <svg width="35" height="35" viewBox="0 0 35 35" class="svg-2zuE5p circleIcon-3489FI" overflow="visible" version="1.1" xmlns="http://www.w3.org/2000/svg" style="width: 35px; height: 35px; background: url(https://upload.wikimedia.org/wikipedia/commons/1/1e/SBurb_Logo.svg) center/contain no-repeat; margin: 5px 0 0 7px;">
<!--                                    <g id="#4be14eff">-->
...
<!--                                    </g>-->
        ...
        this.pestercordIcon.onclick = () => {
            ...
            window.BdApi.showToast(`Attempted to update sounds. Replaced ${total}/3 sounds.`);
        }
